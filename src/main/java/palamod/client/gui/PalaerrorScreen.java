...
public class PalaerrorScreen extends AbstractContainerScreen<PalaerrorMenu> {
	private final static HashMap<String, Object> guistate = PalaerrorMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public PalaerrorScreen(PalaerrorMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("palamod:textures/screens/palaerror0002.png");
