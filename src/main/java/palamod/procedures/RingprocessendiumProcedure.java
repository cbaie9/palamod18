...
public class RingprocessendiumProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(new ResourceLocation("palamod:repairable_endium")))
			...
			if (!(entity instanceof ServerPlayer _plr10 && _plr10.level instanceof ServerLevel && _plr10.getAdvancements().getOrStartProgress(_plr10.server.getAdvancements().getAdvancement(new ResourceLocation("palamod:achmringendium"))).isDone())) {
