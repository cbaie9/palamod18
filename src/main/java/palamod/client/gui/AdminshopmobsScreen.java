...
public class AdminshopmobsScreen extends AbstractContainerScreen<AdminshopmobsMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs.label_adminshop_mobs_menu"), 53, -5, -1);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs.label_page_1"), 77, 5, -1);
	}
	...
	public void init() {
		...
		}).bounds(this.leftPos + 11, this.topPos + 25, 63, 20).build();
