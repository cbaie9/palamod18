...
public class AdminshopblockDirtScreen extends AbstractContainerScreen<AdminshopblockDirtMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblock_dirt.label_dirt"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblock_dirt.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblock_dirt.label_sell_price_01"), 36, 21, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblock_dirt.label_buy_price_10"), 41, 32, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshopblock_dirt.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshopblock_dirt.button_back"), e -> {
			if (true) {
