...
public class DownloaderprocessProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (new Object() {
			...
			if (new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "downloader_linked_account")))) >= StockedbaseadminshopbuyProcedure.execute(world, x, y, z) && (new Object() {
			...
			}.getItemStack(world, new BlockPos(x, y, z), 3)).getItem() == (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						...
						}.getValue(world, new BlockPos(x, y, z), "downloader_linked_account"))), ((new Object() {
							public double getValue(LevelAccessor world, BlockPos pos, String tag) {
								BlockEntity blockEntity = world.getBlockEntity(pos);
								if (blockEntity != null)
									return blockEntity.getTileData().getDouble(tag);
						...
						}.getValue(world, new BlockPos(x, y, z), "downloader_linked_account"))))) - StockedbaseadminshopbuyProcedure.execute(world, x, y, z)));
				...
				if (!world.isClientSide()) {
					...
					BlockState _bs = world.getBlockState(_bp);
					if (_blockEntity != null)
						_blockEntity.getTileData().putBoolean("Has_money", true);
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
			} else {
				if (!world.isClientSide()) {
					...
					BlockState _bs = world.getBlockState(_bp);
					if (_blockEntity != null)
						_blockEntity.getTileData().putBoolean("Has_money", false);
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
			}
