...
public class AssembleurendScreen extends AbstractContainerScreen<AssembleurendMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_the_assembleur_will_deleted_in_t"), 8, 26, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_update_you_can_trade_it_for_a"), 9, 38, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_collectr_grinder"), 10, 51, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_hey_le_chercheur"), 3, 129, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_une_maj_sera_bientot_faite"), 4, 149, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_mais_cest_fufu_qui_doit_sen_ch"), 4, 162, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_donc_tu_a_le_temps_de_trifouille"), 4, 174, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_si_tes_en_jeu_voici_un_surprise"), 6, 185, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.assembleurend.label_bouton"), 6, 195, -12829636);
	}
