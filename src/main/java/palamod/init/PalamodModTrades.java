	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == PalamodModVillagerProfessions.SANTA.get()) {
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(PalamodModBlocks.PALADIUM_BLOCK.get(), 64),
					...
					new ItemStack(PalamodModItems.ENDIUMNUGGET.get()), 1, 5000, 0f));
			...
			event.getTrades().get(2).add(new BasicItemListing(new ItemStack(PalamodModBlocks.UPLOADER.get()), new ItemStack(PalamodModItems.PALADIUMAPPLE.get(), 6), new ItemStack(Items.MUSIC_DISC_CAT), 2, 45, 0.1f));
			...
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(PalamodModBlocks.PALADIUM_GREENBLOCK.get(), 2),

					new ItemStack(PalamodModItems.ENDIUMNUGGET.get(), 2), 1, 5000, 0f));
			event.getTrades().get(4).add(new BasicItemListing(new ItemStack(PalamodModBlocks.PALADIUM_GREENBLOCK.get(), 4),
