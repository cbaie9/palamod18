...
import palamod.procedures.Trxiumdeposittrans0Procedure;
...
public class TrixiumdepositScreen extends AbstractContainerScreen<TrixiumdepositMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("palamod:textures/screens/trixiumdeposit.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack,
				...
				Trxiumdeposittrans0Procedure.execute(entity), 41, 27, -12829636);
	}
