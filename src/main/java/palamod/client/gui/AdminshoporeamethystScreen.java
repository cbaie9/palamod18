...
public class AdminshoporeamethystScreen extends AbstractContainerScreen<AdminshoporeamethystMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporeamethyst.label_amethyst"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporeamethyst.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporeamethyst.label_sell_price_70"), 39, 28, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporeamethyst.label_buy_price_75"), 45, 40, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshoporeamethyst.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshoporeamethyst.button_back"), e -> {
			if (true) {
