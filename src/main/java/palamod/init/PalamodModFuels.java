...
public class PalamodModFuels {
	...
	public static void furnaceFuelBurnTimeEvent(FurnaceFuelBurnTimeEvent event) {
		...
		if (itemstack.getItem() == PalamodModBlocks.JACARANDA_PLANKS.get().asItem())
			...
			event.setBurnTime(400);
		else if (itemstack.getItem() == PalamodModItems.GOLDMIXEDCOAL.get())
			event.setBurnTime(16000);
		else if (itemstack.getItem() == PalamodModItems.AMETHYSTMIXEDCOAL.get())
			event.setBurnTime(20000);
		else if (itemstack.getItem() == PalamodModItems.TITANEMIXEDCOAL.get())
			event.setBurnTime(24000);
		else if (itemstack.getItem() == PalamodModItems.PALAMIXEDCHARCOAL.get())
