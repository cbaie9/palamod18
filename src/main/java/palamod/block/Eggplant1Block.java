...
public class Eggplant1Block extends FlowerBlock {
	...
	public ItemStack getCloneItemStack(BlockState state, HitResult target, BlockGetter world, BlockPos pos, Player player) {
		return new ItemStack(PalamodModItems.EGGPLANTSEED.get());
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(PalamodModBlocks.EGGPLANT_1.get(), renderType -> renderType == RenderType.cutout());
	}
}
