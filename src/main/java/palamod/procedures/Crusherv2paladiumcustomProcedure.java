...
public class Crusherv2paladiumcustomProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "crusher_num_paladium") >= (double) PalamodserverconfirgurationConfiguration.CRUSHER_PALADIUM.get()) {
			{
				...
				if (_ent != null) {
					...
					}.getAmount(world, BlockPos.containing(x, y, z), 2) + (double) PalamodserverconfirgurationConfiguration.CRUSHER_OUT_PALADIUM.get()));
