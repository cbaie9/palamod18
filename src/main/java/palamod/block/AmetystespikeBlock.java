...
public class AmetystespikeBlock extends Block {
	...
	public void entityInside(BlockState blockstate, Level world, BlockPos pos, Entity entity) {
		...
		Ametyste_spike_damageProcedure.execute(entity);
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(PalamodModBlocks.AMETYSTESPIKE.get(), renderType -> renderType == RenderType.cutout());
	}
}
