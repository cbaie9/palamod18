...
public class ForgepalahelpguiScreen extends AbstractContainerScreen<ForgepalahelpguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.forgepalahelpgui.label_paladium_forge"), 5, 2, -65485);
	...
	public void init() {
		...
		button_back = new Button(this.leftPos + 2, this.topPos + 14, 45, 20, new TranslatableComponent("gui.palamod.forgepalahelpgui.button_back"), e -> {
			if (true) {
		...
		button_menu = new Button(this.leftPos + 2, this.topPos + 35, 45, 20, new TranslatableComponent("gui.palamod.forgepalahelpgui.button_menu"), e -> {
			if (true) {
