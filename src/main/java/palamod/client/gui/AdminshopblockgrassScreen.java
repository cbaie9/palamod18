...
public class AdminshopblockgrassScreen extends AbstractContainerScreen<AdminshopblockgrassMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblockgrass.label_grass"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblockgrass.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblockgrass.label_sell_price_03"), 34, 24, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblockgrass.label_buy_price_15"), 42, 38, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshopblockgrass.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshopblockgrass.button_back"), e -> {
			if (true) {
