...
public class PalamodModEntities {
	...
	public static final RegistryObject<EntityType<ElephantlittleEntity>> ELEPHANTLITTLE = register("elephantlittle",
			EntityType.Builder.<ElephantlittleEntity>of(ElephantlittleEntity::new, MobCategory.MISC).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ElephantlittleEntity::new)
