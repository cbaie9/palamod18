...
public class IronspikeBlock extends Block {
	...
	public IronspikeBlock() {
		super(BlockBehaviour.Properties.of(Material.CACTUS).sound(SoundType.METAL).strength(3f, 10f).requiresCorrectToolForDrops().noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("beta / no craft / creative"));
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(PalamodModBlocks.IRONSPIKE.get(), renderType -> renderType == RenderType.cutout());
	}
}
