...
public class PalamodModVillagerProfessions {
	...
	public static final RegistryObject<VillagerProfession> SANTA = registerProfession("santa", () -> PalamodModBlocks.CLOUDBLOCK.get(), () -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.work_cartographer")));
