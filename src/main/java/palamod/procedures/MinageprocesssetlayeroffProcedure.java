			...
			if (!(PalamodModBlocks.NBTBLOCK.get() == (world.getBlockState(new BlockPos(0, 10, 0))).getBlock())) {
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						_blockEntity.getTileData().putBoolean(("Minage_setlayer_" + entity.getDisplayName().getString()), (false));
				...
				if (!world.isClientSide()) {
					...
					BlockState _bs = world.getBlockState(_bp);
					if (_blockEntity != null)
						_blockEntity.getTileData().putBoolean(("Minage_setlayer_dynamic_" + entity.getDisplayName().getString()), (false));
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
			}
