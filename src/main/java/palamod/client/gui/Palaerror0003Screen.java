...
public class Palaerror0003Screen extends AbstractContainerScreen<Palaerror0003Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.palaerror_0003.label_err0r_0003_hdv"), 39, 3, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.palaerror_0003.label_you_dont_have_the_required"), 6, 14, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.palaerror_0003.label_money_for_buying_this_item"), 4, 25, -12829636);
	}
	...
	public void init() {
		...
		button_return_to_hdv = new Button(this.leftPos + 40, this.topPos + 41, 92, 20, new TranslatableComponent("gui.palamod.palaerror_0003.button_return_to_hdv"), e -> {
			if (true) {
