...
public class EndiumchestguiScreen extends AbstractContainerScreen<EndiumchestguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("palamod:textures/screens/endiumchestgui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.endiumchestgui.label_inventory"), 39, 42, -12829636);
	}
