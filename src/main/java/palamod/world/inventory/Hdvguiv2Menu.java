...
public class Hdvguiv2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Hdvguiv2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PalamodModMenus.HDVGUIV_2, id);
