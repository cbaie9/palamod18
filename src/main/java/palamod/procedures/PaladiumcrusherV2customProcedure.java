...
public class PaladiumcrusherV2customProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (PalamodserverconfirgurationConfiguration.CRUSHER_CUSTOM.get()) {
			...
			if ((new Object() {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == PalamodModItems.PALAMIXEDCHARCOAL.get() && (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getValue(world, BlockPos.containing(x, y, z), "crusher_num_endium") < (double) PalamodserverconfirgurationConfiguration.CRUSHER_ENDIUM.get() && (new Object() {
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 2) <= 64 - (double) PalamodserverconfirgurationConfiguration.CRUSHER_OUT_ENDIUM.get() || (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
				...
				}.getValue(world, BlockPos.containing(x, y, z), "crusher_state") >= (double) PalamodserverconfirgurationConfiguration.CRUSHER_STATE.get()) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == PalamodModItems.TITANEMIXEDCOAL.get() && (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getValue(world, BlockPos.containing(x, y, z), "crusher_num_paladium") < (double) PalamodserverconfirgurationConfiguration.CRUSHER_PALADIUM.get() && (new Object() {
				public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicInteger _retval = new AtomicInteger(0);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 2) <= 64 - (double) PalamodserverconfirgurationConfiguration.CRUSHER_OUT_PALADIUM.get() || (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == PalamodModItems.AMETHYSTMIXEDCOAL.get() && (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getValue(world, BlockPos.containing(x, y, z), "crusher_num_titane") < (double) PalamodserverconfirgurationConfiguration.CRUSHER_TITANE.get() && (new Object() {
				public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicInteger _retval = new AtomicInteger(0);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 2) <= 64 - (double) PalamodserverconfirgurationConfiguration.CRUSHER_OUT_TITANE.get() || (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == PalamodModItems.GOLDMIXEDCOAL.get() && (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getValue(world, BlockPos.containing(x, y, z), "crusher_num_amethyst") < (double) PalamodserverconfirgurationConfiguration.CRUSHER_AMETHYST.get() && (new Object() {
				public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicInteger _retval = new AtomicInteger(0);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 2) <= 64 - (double) PalamodserverconfirgurationConfiguration.CRUSHER_OUT_AMETHYST.get() || (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
