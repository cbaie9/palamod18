...
public class Adminshopmobs2featherScreen extends AbstractContainerScreen<Adminshopmobs2featherMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_2feather.label_paladium"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_2feather.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_2feather.label_sell_price_120"), 25, 30, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_2feather.label_buy_price_125"), 24, 44, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshopmobs_2feather.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2feather.button_back"), e -> {
			if (true) {
