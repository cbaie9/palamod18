...
public class AdminshopmobsRottenfleshScreen extends AbstractContainerScreen<AdminshopmobsRottenfleshMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_rottenflesh.label_paladium"), 61, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_rottenflesh.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_rottenflesh.label_sell_price_120"), 25, 30, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopmobs_rottenflesh.label_buy_price_125"), 25, 44, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshopmobs_rottenflesh.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshopmobs_rottenflesh.button_back"), e -> {
			if (true) {
