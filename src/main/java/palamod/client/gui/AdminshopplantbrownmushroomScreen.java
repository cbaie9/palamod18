...
public class AdminshopplantbrownmushroomScreen extends AbstractContainerScreen<AdminshopplantbrownmushroomMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopplantbrownmushroom.label_paladium"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopplantbrownmushroom.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopplantbrownmushroom.label_sell_price_120"), 25, 30, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopplantbrownmushroom.label_buy_price_125"), 25, 44, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshopplantbrownmushroom.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshopplantbrownmushroom.button_back"), e -> {
			if (true) {
