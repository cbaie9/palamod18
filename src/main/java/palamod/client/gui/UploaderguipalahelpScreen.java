...
public class UploaderguipalahelpScreen extends AbstractContainerScreen<UploaderguipalahelpMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("palamod:textures/screens/uploaderguipalahelp.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack,
				...
				Palahelpuploader1Procedure.execute(entity), 4, 71, -12829636);
		this.font.draw(poseStack,

				Palahelpuploader2Procedure.execute(entity), 4, 82, -12829636);
	}
