...
public class AdminshoporegoldScreen extends AbstractContainerScreen<AdminshoporegoldMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporegold.label_gold"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporegold.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporegold.label_sell_price_30"), 41, 27, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporegold.label_buy_price_35"), 47, 42, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshoporegold.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshoporegold.button_back"), e -> {
			if (true) {
