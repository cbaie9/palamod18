...
public class Crusherv2titanecustomProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "crusher_num_titane") >= (double) PalamodserverconfirgurationConfiguration.CRUSHER_TITANE.get()) {
			{
				...
				if (_ent != null) {
					...
					}.getAmount(world, BlockPos.containing(x, y, z), 2) + (double) PalamodserverconfirgurationConfiguration.CRUSHER_OUT_TITANE.get()));
