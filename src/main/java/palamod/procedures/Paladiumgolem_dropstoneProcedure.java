...
public class Paladiumgolem_dropstoneProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		new ItemStack(PalamodModItems.GUARDIANSTONE.get()).setHoverName(Component.literal(("Guardian stone - Contain " + entity.getPersistentData().getDouble("Golem_level") + " level Golem")));
