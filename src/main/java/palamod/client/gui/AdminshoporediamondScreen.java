...
public class AdminshoporediamondScreen extends AbstractContainerScreen<AdminshoporediamondMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporediamond.label_diamond"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporediamond.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporediamond.label_buy_price_40"), 36, 25, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoporediamond.label_sell_price_45"), 34, 39, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshoporediamond.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshoporediamond.button_back"), e -> {
			if (true) {
