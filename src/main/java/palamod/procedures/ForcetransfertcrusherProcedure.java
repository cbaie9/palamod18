...
public class ForcetransfertcrusherProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "crusher_num")) / 128) {
				{
			...
			}.getValue(world, new BlockPos(x, y, z), "crusher_num")) / 64) {
				{
					BlockEntity _ent = world.getBlockEntity(new BlockPos(x, y, z));
					if (_ent != null) {
						final int _slotid = 2;
			...
			}.getValue(world, new BlockPos(x, y, z), "crusher_num")) / 32) {
				{
					BlockEntity _ent = world.getBlockEntity(new BlockPos(x, y, z));
					if (_ent != null) {
						final int _slotid = 2;
			...
			}.getValue(world, new BlockPos(x, y, z), "crusher_num")) / 16) {
				{
					BlockEntity _ent = world.getBlockEntity(new BlockPos(x, y, z));
					if (_ent != null) {
						final int _slotid = 2;
		...
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				_blockEntity.getTileData().putString("crusher_mode", "None");
		...
		if (!world.isClientSide()) {
			...
			BlockState _bs = world.getBlockState(_bp);
			if (_blockEntity != null)
				_blockEntity.getTileData().putBoolean("crusher_lock", (true));
			if (world instanceof Level _level)
				_level.sendBlockUpdated(_bp, _bs, _bs, 3);
		}
		if (!world.isClientSide()) {
			...
			BlockState _bs = world.getBlockState(_bp);
			if (_blockEntity != null)
				_blockEntity.getTileData().putDouble("crusher_num", 0);
			if (world instanceof Level _level)
				_level.sendBlockUpdated(_bp, _bs, _bs, 3);
		}
	}
