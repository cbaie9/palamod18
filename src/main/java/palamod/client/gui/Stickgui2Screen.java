...
public class Stickgui2Screen extends AbstractContainerScreen<Stickgui2Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.stickgui_2.label_strenght_stick_vous_donne_forc"), 3, 33, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.stickgui_2.label_craft_de_la_strenght_orb"), 261, 62, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.stickgui_2.label_empty"), 341, 76, -12829636);
	}
	...
	public void init() {
		super.init();
		button_stick_prcdant = Button.builder(Component.translatable("gui.palamod.stickgui_2.button_stick_prcdant"), e -> {
			if (true) {
		...
		button_stick_suivant = Button.builder(Component.translatable("gui.palamod.stickgui_2.button_stick_suivant"), e -> {
			if (true) {
		...
		button_item_menu = Button.builder(Component.translatable("gui.palamod.stickgui_2.button_item_menu"), e -> {
			if (true) {
		...
		button_menu = Button.builder(Component.translatable("gui.palamod.stickgui_2.button_menu"), e -> {
			if (true) {
