...
public class AdminshoputilitiesScreen extends AbstractContainerScreen<AdminshoputilitiesMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoputilities.label_adminshop_plant_section"), 23, 1, -52480);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoputilities.label_wip"), 76, 11, -1);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshoputilities.label_fast_sell"), 74, 156, -3407872);
	}
