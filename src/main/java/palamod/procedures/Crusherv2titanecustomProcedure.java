...
public class Crusherv2titanecustomProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (new Object() {
		...
		}.getValue(world, new BlockPos(x, y, z), "crusher_num_titane") >= (double) PalamodserverconfirgurationConfiguration.CRUSHER_TITANE.get()) {
			{
				...
				if (_ent != null) {
					...
					}.getAmount(world, new BlockPos(x, y, z), 2) + (double) PalamodserverconfirgurationConfiguration.CRUSHER_OUT_TITANE.get()));
			...
			if (!world.isClientSide()) {
				...
				if (_blockEntity != null)
					_blockEntity.getTileData().putDouble("crusher_num_titane", 0);
