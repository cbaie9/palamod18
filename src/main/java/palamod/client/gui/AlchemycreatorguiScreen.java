...
public class AlchemycreatorguiScreen extends AbstractContainerScreen<AlchemycreatorguiMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("palamod:textures/screens/alchemy_arrow.png"));
		this.blit(ms, this.leftPos + 122, this.topPos + 25, 0, 0, 16, 16, 16, 16);
