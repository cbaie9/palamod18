...
public class PhonecodeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, HashMap guistate) {
		...
		if ((guistate.containsKey("text:cheat_code_secret") ? ((EditBox) guistate.get("text:cheat_code_secret")).getValue() : "").contains("cbaie9")
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("No suicide today please. Suicide is bad :{"), false);
			if (entity instanceof Player _player)
				_player.closeContainer();
			...
			new ItemStack(PalamodModItems.LEGENDARYSTONEPOWER.get()).setHoverName(Component.literal("Legudary diorite of unPower"));
