...
public class AdminshopblockgrassScreen extends AbstractContainerScreen<AdminshopblockgrassMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.adminshopblockgrass.label_grass"), 58, 6, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.adminshopblockgrass.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.adminshopblockgrass.label_sell_price_03"), 34, 24, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.adminshopblockgrass.label_buy_price_15"), 42, 38, -12829636);
	}
	...
	public void init() {
		...
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, new TranslatableComponent("gui.palamod.adminshopblockgrass.number_buy")) {
			{
				setSuggestion(new TranslatableComponent("gui.palamod.adminshopblockgrass.number_buy").getString());
			}
		...
		button_buy = new Button(this.leftPos + 26, this.topPos + 109, 40, 20, new TranslatableComponent("gui.palamod.adminshopblockgrass.button_buy"), e -> {
			if (true) {
		...
		button_sell = new Button(this.leftPos + 99, this.topPos + 109, 46, 20, new TranslatableComponent("gui.palamod.adminshopblockgrass.button_sell"), e -> {
			if (true) {
		...
		button_back = new Button(this.leftPos + 7, this.topPos + 139, 46, 20, new TranslatableComponent("gui.palamod.adminshopblockgrass.button_back"), e -> {
			if (true) {
