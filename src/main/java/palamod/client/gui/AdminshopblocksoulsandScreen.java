...
public class AdminshopblocksoulsandScreen extends AbstractContainerScreen<AdminshopblocksoulsandMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblocksoulsand.label_soulsand"), 58, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblocksoulsand.label_mode_set"), 29, 74, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblocksoulsand.label_sell_price_05"), 38, 24, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.adminshopblocksoulsand.label_buy_price_20"), 44, 42, -12829636);
	}
	...
	public void init() {
		super.init();
		number_buy = new EditBox(this.font, this.leftPos + 26, this.topPos + 87, 120, 20, Component.translatable("gui.palamod.adminshopblocksoulsand.number_buy")) {
			{
		...
		button_back = Button.builder(Component.translatable("gui.palamod.adminshopblocksoulsand.button_back"), e -> {
			if (true) {
