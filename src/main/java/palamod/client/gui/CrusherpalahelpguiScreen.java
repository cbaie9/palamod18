...
public class CrusherpalahelpguiScreen extends AbstractContainerScreen<CrusherpalahelpguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.crusherpalahelpgui.label_beta_nochange_0004"), 3, 184, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.palamod.crusherpalahelpgui.label_paladium_crusher_wiki"), 111, 3, -65485);
		...
		this.font.draw(poseStack, Component.translatable("gui.palamod.crusherpalahelpgui.label_11_v1"), 374, 183, -12829636);
	}
	...
	public void init() {
		super.init();
		button_back = Button.builder(Component.translatable("gui.palamod.crusherpalahelpgui.button_back"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 211, this.topPos + 172, 45, 20).build();
		guistate.put("button:button_back", button_back);
		this.addRenderableWidget(button_back);
		button_menu = Button.builder(Component.translatable("gui.palamod.crusherpalahelpgui.button_menu"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 260, this.topPos + 172, 45, 20).build();
		guistate.put("button:button_menu", button_menu);
		this.addRenderableWidget(button_menu);
		button_gui = Button.builder(Component.translatable("gui.palamod.crusherpalahelpgui.button_gui"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 241, this.topPos + 19, 86, 20).build();
