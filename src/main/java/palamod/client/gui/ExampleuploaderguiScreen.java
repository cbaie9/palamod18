...
public class ExampleuploaderguiScreen extends AbstractContainerScreen<ExampleuploaderguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("palamod:textures/screens/exampleuploadergui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("palamod:textures/screens/golem_treec_sep_nt1.png"));
		this.blit(ms, this.leftPos + 77, this.topPos + 45, 0, 0, 16, 16, 16, 16);
