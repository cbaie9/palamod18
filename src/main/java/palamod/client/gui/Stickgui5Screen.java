...
public class Stickgui5Screen extends AbstractContainerScreen<Stickgui5Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.palamod.stickgui_5.label_hyperjump_vous_donne_saut_9_p"), 3, 33, -12829636);
	}
	...
	public void init() {
		super.init();
		button_stick_prcdant = Button.builder(Component.translatable("gui.palamod.stickgui_5.button_stick_prcdant"), e -> {
			if (true) {
		...
		button_stick_suivant = Button.builder(Component.translatable("gui.palamod.stickgui_5.button_stick_suivant"), e -> {
			if (true) {
		...
		button_item_menu = Button.builder(Component.translatable("gui.palamod.stickgui_5.button_item_menu"), e -> {
			if (true) {
		...
		button_menu = Button.builder(Component.translatable("gui.palamod.stickgui_5.button_menu"), e -> {
			if (true) {
