...
public class EndiumchestguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EndiumchestguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PalamodModMenus.ENDIUMCHESTGUI, id);
		...
		this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 132, 4) {
		}));
		this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 132, 22) {
		}));
