...
public class SafeguiScreen extends AbstractContainerScreen<SafeguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("palamod:textures/screens/safegui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.safegui.label_safe"), 72, 4, -12829636);
	}
