...
public class HdvsellguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HdvsellguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PalamodModMenus.HDVSELLGUI.get(), id);
