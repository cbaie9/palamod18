...
public class Upgradepotgv2Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		Pickaxe_stone_seen = itemstack.getOrCreateTag().getDouble("Pickaxe_stone");
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.STONE || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.GRANITE || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.DIORITE
			...
			itemstack.getOrCreateTag().putDouble("Pickaxe_stone", (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") + 1));
			if (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") >= 2000000) {
				...
				(itemstack).enchant(Enchantments.BLOCK_FORTUNE, 3);
				(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("Pickaxe_stone", (Pickaxe_stone_seen + 1));
			} else if (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") >= 7440) {
				if (entity instanceof LivingEntity _entity) {
				...
				(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("Pickaxe_stone", (Pickaxe_stone_seen + 1));
			} else if (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") >= 6750) {
				if (entity instanceof LivingEntity _entity) {
				...
				(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("Pickaxe_stone", (Pickaxe_stone_seen + 1));
			} else if (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") >= 5150) {
				if (entity instanceof LivingEntity _entity) {
				...
				(itemstack).enchant(Enchantments.BLOCK_EFFICIENCY, 5);
				(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("Pickaxe_stone", (Pickaxe_stone_seen + 1));
			} else if (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") >= 4563) {
				if (entity instanceof LivingEntity _entity) {
				...
				(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("Pickaxe_stone", (Pickaxe_stone_seen + 1));
			} else if (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") >= 8684) {
				if (entity instanceof LivingEntity _entity) {
				...
				(entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("Pickaxe_stone", (Pickaxe_stone_seen + 1));
			} else if (itemstack.getOrCreateTag().getDouble("Pickaxe_stone") >= 2616) {
				if (entity instanceof LivingEntity _entity) {
		...
		if (EnchantmentHelper.getItemEnchantmentLevel(PalamodModEnchantments.BIGHOLE.get(), itemstack) != 0
				&& ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalamodModItems.PALAMIXEDCHARCOAL.get())) : false) || 0 < itemstack.getOrCreateTag().getDouble("potg_fuel"))) {
		...
		if (EnchantmentHelper.getItemEnchantmentLevel(PalamodModEnchantments.AUTOSMELTPOTG.get(), itemstack) != 0
				&& (world instanceof Level _lvlCanSmelt ? _lvlCanSmelt.getRecipeManager().getRecipeFor(RecipeType.SMELTING, new SimpleContainer(itemstack), _lvlCanSmelt).isPresent() : false)) {
