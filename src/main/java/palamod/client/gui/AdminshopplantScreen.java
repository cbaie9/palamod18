...
public class AdminshopplantScreen extends AbstractContainerScreen<AdminshopplantMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 0, this.topPos + -3, 0, 0, 100, 24, 100, 24);

		RenderSystem.setShaderTexture(0, new ResourceLocation("palamod:textures/screens/right_gray_line.png"));
		this.blit(ms, this.leftPos + 89, this.topPos + -3, 0, 0, 100, 24, 100, 24);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.adminshopplant.label_adminshop_seed_menu"), 46, 4, -1);
	}
	...
	public void init() {
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 165, this.topPos + 1, 16, 16, 0, 0, 16, new ResourceLocation("palamod:textures/screens/atlas/imagebutton_cross_no_button.png"), 16, 32, e -> {
			if (true) {
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 7, this.topPos + 2, 16, 16, 0, 0, 16, new ResourceLocation("palamod:textures/screens/atlas/imagebutton_arrow_adminshop.png"), 16, 32, e -> {
			if (true) {
