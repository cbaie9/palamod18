...
public class FactioncreateguiSlotMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(FactioncreateguiSlotMessage.class, FactioncreateguiSlotMessage::buffer, FactioncreateguiSlotMessage::new, FactioncreateguiSlotMessage::handler);
	}
}
