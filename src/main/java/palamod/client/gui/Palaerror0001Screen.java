...
import palamod.network.Palaerror0001ButtonMessage;
...
public class Palaerror0001Screen extends AbstractContainerScreen<Palaerror0001Menu> {
	private final static HashMap<String, Object> guistate = Palaerror0001Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_reconnect_to_hdv;

	public Palaerror0001Screen(Palaerror0001Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("palamod:textures/screens/palaerror_0001.png");
