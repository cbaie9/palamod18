		...
		if (new Object() {
			...
			if (!(EnchantmentHelper.getItemEnchantmentLevel(PalamodModEnchantments.SMELT.get(), (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					...
					}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == PalamodModItems.SMELTMODIFIER.get()) {
				if (!world.isClientSide()) {
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockEntity _blockEntity = world.getBlockEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
			...
			if ((!(EnchantmentHelper.getItemEnchantmentLevel(PalamodModEnchantments.SPEED.get(), (new Object() {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == PalamodModItems.SPEEDMODIFIER.get()) {
				if (!world.isClientSide()) {
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockEntity _blockEntity = world.getBlockEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
				...
				if (new Object() {
					...
					(entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(5)).getItem() : ItemStack.EMPTY)
							.enchant(PalamodModEnchantments.SPEED.get(), (int) ((new Object() {
								public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
									AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
									BlockEntity _ent = world.getBlockEntity(pos);
									if (_ent != null)
			...
			if ((!(EnchantmentHelper.getItemEnchantmentLevel(PalamodModEnchantments.SPEED.get(), (new Object() {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == PalamodModItems.FORTURNEMODIFIER.get()) {
				if (!world.isClientSide()) {
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockEntity _blockEntity = world.getBlockEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
				...
				if (new Object() {
					...
					(entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(5)).getItem() : ItemStack.EMPTY)
							.enchant(PalamodModEnchantments.HAMMER_FORTUNE.get(), (int) ((new Object() {
								public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
									AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
									BlockEntity _ent = world.getBlockEntity(pos);
									if (_ent != null)
			...
			if (((new Object() {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == PalamodModItems.BIGHOLEUPGRADE.get() && (EnchantmentHelper.getItemEnchantmentLevel(PalamodModEnchantments.BIGHOLE.get(), (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
					...
					&& 2 > (entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(5)).getItem() : ItemStack.EMPTY)
							.getEnchantmentLevel(PalamodModEnchantments.BIGHOLE.get())
				...
				if (new Object() {
					...
					(entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(5)).getItem() : ItemStack.EMPTY).enchant(
							PalamodModEnchantments.BIGHOLE.get(),
							(int) ((entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(5)).getItem() : ItemStack.EMPTY)
									.getEnchantmentLevel(PalamodModEnchantments.BIGHOLE.get()) + 1));
					if (world.getLevelData().getGameRules().getBoolean(PalamodModGameRules.LOGSALL)) {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == PalamodModItems.AUTOSMELTUPGRADEPOTG.get() && !(EnchantmentHelper.getItemEnchantmentLevel(PalamodModEnchantments.AUTOSMELTPOTG.get(), (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
