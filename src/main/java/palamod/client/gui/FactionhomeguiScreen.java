...
public class FactionhomeguiScreen extends AbstractContainerScreen<FactionhomeguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.factionhomegui.label_faction_home"), 116, 3, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.factionhomegui.label_level_varfaction_max_xp"), 5, 31, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.palamod.factionhomegui.label_empty"), 19, 71, -12829636);
	}
	...
	public void init() {
		...
		button_invite = new Button(this.leftPos + 8, this.topPos + 171, 56, 20, new TranslatableComponent("gui.palamod.factionhomegui.button_invite"), e -> {
		});
