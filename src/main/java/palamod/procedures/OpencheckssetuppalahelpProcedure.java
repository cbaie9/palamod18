...
public class OpencheckssetuppalahelpProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity.getPersistentData().getString("language")).equals("french") || (entity.getPersistentData().getString("language")).equals("english")) {
			{
				if (entity instanceof ServerPlayer _ent) {
					...
					NetworkHooks.openGui((ServerPlayer) _ent, new MenuProvider() {
						...
						public Component getDisplayName() {
							return new TextComponent("Palahelpgui1");
						}
		...
		} else {
			{
				if (entity instanceof ServerPlayer _ent) {
					...
					NetworkHooks.openGui((ServerPlayer) _ent, new MenuProvider() {
						@Override
						public Component getDisplayName() {
							return new TextComponent("Languageselection");
						}
